...
<form>
    <table class="add">
        ...
        <tr>
            ...
            <td><input type="text" name="header" id="input_header"></td>
            <td><input type="text" name="body" id="input_date"></td>
			<td><select class="form-control ml-2" name="status" id="element_input_status">
